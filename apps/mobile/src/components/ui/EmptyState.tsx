...
const createStyles = (colors: ThemeColors) => StyleSheet.create({ root: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: spacing[8] }, icon: { color: colors.brandText, fontSize: 36 }, title: { color: colors.offWhite, fontSize: typography.h3, fontWeight: '900', textAlign: 'center', marginTop: spacing[3] }, description: { color: colors.textMuted, lineHeight: 21, textAlign: 'center', marginTop: spacing[2] } })
