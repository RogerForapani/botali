...
export function PriceModal({ visible, station, initialFuel, userId, onClose, onBack, onSent }: { visible: boolean; station: Station | null; initialFuel: FuelCode; userId: string | null; onClose: () => void; onBack?: () => void; onSent: () => void }) {
