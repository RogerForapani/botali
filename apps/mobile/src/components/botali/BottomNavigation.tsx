...
const createStyles = (colors: ThemeColors) => StyleSheet.create({ root: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 66, paddingTop: spacing[2], flexDirection: 'row', backgroundColor: colors.surface, borderTopWidth: 1, borderTopColor: colors.border }, item: { flex: 1, alignItems: 'center', justifyContent: 'center' }, contribute: { marginTop: -21 }, icon: { color: colors.textMuted, fontSize: 22, fontWeight: '800' }, label: { color: colors.textMuted, fontSize: 9, marginTop: 2 }, active: { color: colors.brandText } })
