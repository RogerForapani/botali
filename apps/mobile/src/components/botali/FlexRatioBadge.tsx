...
const styles = StyleSheet.create({ badge: { alignSelf: 'flex-start', paddingHorizontal: spacing[2], paddingVertical: 5, borderRadius: radius.full }, good: { backgroundColor: '#143D2A' }, warning: { backgroundColor: '#4A3510' }, text: { color: baseColors.offWhite, fontSize: 10, fontWeight: '800' } })
