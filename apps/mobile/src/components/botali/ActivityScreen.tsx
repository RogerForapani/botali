...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  card: { padding: spacing[4], borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, backgroundColor: colors.surface, flexDirection: 'row', alignItems: 'center', gap: spacing[3] }, rejectedCard: { borderColor: colors.danger },
  ...
  date: { color: colors.textMuted, fontSize: 11, marginTop: 3 }, reason: { color: colors.dangerText, fontFamily: typography.semibold, fontSize: 11, lineHeight: 16, marginTop: spacing[2] },
