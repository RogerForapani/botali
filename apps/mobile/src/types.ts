...
export interface FuelPrice { value: number; confidence: number; reports?: number; confirmations?: number; disagreements?: number; updatedAt?: string; submissionId?: string; stale?: boolean }
