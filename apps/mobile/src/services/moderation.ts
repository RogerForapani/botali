...
type EditPayload = { name?: string; brand?: string; address?: string; neighborhood?: string; city?: string; state?: string; postal_code?: string; latitude?: number; longitude?: number; fuel_codes?: string[]; service_codes?: string[] }
